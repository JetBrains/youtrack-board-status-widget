...
const AGILE_FIELDS = 'id,name,sprints(id,name,start,finish),sprintsSettings(disableSprints,explicitQuery),columnSettings(field(id,name)),owner(id,ringId,fullName)';
